...
TraceablePeerConnection.prototype._createOfferOrAnswer = function (isOffer, constraints) {
    ...
    if (this._usesTransceiverCodecPreferences) {
        ...
        if (transceiver) {
            ...
            const disabledCodecMimeType = (_b = this.codecPreference) === null || _b === void 0 ? void 0 : _b.disabledCodecMimeType;
            const mimeType = (_c = this.codecPreference) === null || _c === void 0 ? void 0 : _c.mimeType;
            ...
            try {
                ...
                logger.warn(`${this} Setting codec[preference=${mimeType},disabledCodecMimeType=${disabledCodecMimeType}] failed`, err);
            }
        }
    }
    return new Promise((resolve, reject) => {
